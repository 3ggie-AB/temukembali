...
export default function TemuanEdit({ auth, temuan }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('temuan.upload-foto', temuan.id), {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Upload Foto Temuan</h2>}
        >
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        {temuan.photo ? (
                            <div>
                                ...
                                <img src={'/' + temuan.photo} alt="Foto Lama" className="max-h-64 rounded border" />
                            </div>
                        ) : (
                            <div>
                                <p className="text-gray-700 dark:text-gray-300 mb-1">Foto Lama:</p>
